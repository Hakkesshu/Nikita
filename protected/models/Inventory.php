...
class Inventory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('movieId, stockNum, purchaseDate', 'required'),
			array('movieId, stockNum', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('inventoryId, movieId, stockNum, purchaseDate', 'safe', 'on'=>'search'),
		);
	}
